...
int VulkanApp::init() {
    ...
    //auto shared_app = std::make_shared<VulkanApp>(this);
    //(std::shared_ptr<VulkanApp>)this
    //ui = std::make_shared<VulkanUI>(std::make_shared<VulkanApp>(this), window, device, presentQueue, width, height);
    //ui = std::make_shared<VulkanUI>(shared_from_this(), window, device, presentQueue, width, height);
    ui = std::make_shared<VulkanUI>(this, window, device, presentQueue, width, height);
